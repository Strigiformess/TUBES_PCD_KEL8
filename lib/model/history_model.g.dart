...
class HistoryItemAdapter extends TypeAdapter<HistoryItem> {
  ...
  void write(BinaryWriter writer, HistoryItem obj) {
    writer
      ...
      ..writeByte(1)..write(obj.foodName)
      ..writeByte(2)..write(obj.imagePath)
      ..writeByte(3)..write(obj.skor)
      ..writeByte(4)..write(obj.kategori)
      ..writeByte(5)..write(obj.createdAt)
      ..writeByte(6)..write(obj.skorWarna)
      ..writeByte(7)..write(obj.skorKecerahan)
      ..writeByte(8)..write(obj.skorTekstur)
      ..writeByte(9)..write(obj.skorKerusakan);
  }
