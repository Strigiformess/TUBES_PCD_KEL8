...
class ScannerTab extends StatelessWidget {
  ...
  Future<void> _pick(BuildContext context, ImageSource src) async {
    final picked = await ImagePicker().pickImage(
      source: src, imageQuality: 85, maxWidth: 1200,
    );
    ...
    return Column(children: [
            ...
            Positioned(top: 12, left: 32,
              child: Container(
                ...
                child: const Row(children: [
                  ...
                  SizedBox(width: 6),
                  Text('PCD ACTIVE', style: TextStyle(
      ...
      Padding(
        ...
        child: Column(children: [
          // Camera / Gallery
          Row(children: [
            _PickBtn(icon: Icons.camera_alt_outlined, label: 'CAMERA',
              onTap: () => _pick(context, ImageSource.camera)),
            const SizedBox(width: 12),
            _PickBtn(icon: Icons.photo_library_outlined, label: 'GALLERY',
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: ctrl.selectedImage == null || ctrl.scanState == ScanState.loading
                  ? null : () => _analyze(context),
              icon: ctrl.scanState == ScanState.loading
                  ? const SizedBox(width: 18, height: 18,
                      child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white))
                  : const Icon(Icons.analytics_outlined, size: 20),
              label: Text(
                ctrl.scanState == ScanState.loading ? 'Analyzing...' : 'Analyze Now',
          ...
          if (ctrl.scanState == ScanState.error) ...[
            ...
            Container(
              ...
              child: Text(ctrl.errorMsg, style: const TextStyle(
